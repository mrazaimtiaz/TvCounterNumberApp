...
public abstract class PaciCardReaderAbstractTelpo implements DisposableInterface {
    ...
    public PaciCardReaderAbstractTelpo(boolean var1, SmartCardReader mReader) {

...
public final class MyPACICardAPI {
  ...
  //  ArrayList<PaciEventHandler> MyEvent;
    ...
    public void CardDisconnectionEvent(int var1) {
        try {
...
*/
    ...
    public void CardConnectionEvent(int var1, byte[] var2) {
    ...
    public void ReaderChangeEvent(String[] var1) {
